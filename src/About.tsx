const About = () => {
  ...
  return (
    <div className="relative z-50 flex flex-col md:flex-row lg:flex-row flex-wrap justify-around items-center text-white bg-black rounded-xl pt-[15%] pb-[10%]">
      <h2 className="pl-10   w-full text-3xl font-semibold">About me</h2>
