...
const About = () => {
  ...
  return (
    <div id="goto-about" className="relative z-50 flex flex-col md:flex-row lg:flex-row flex-wrap justify-around items-center text-white bg-black rounded-xl pt-[15%] pb-[10%] lg:py-[5%] lg:px-10">
      <h2 className="mb-8 lg:mb-4 pl-10 lg:pl-6 w-full text-3xl font-semibold">About me</h2>
