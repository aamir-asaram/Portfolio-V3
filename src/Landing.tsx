...
const Landing = () => {
  const handleScroll = () => {
    ...
    const head1 = document.getElementById('landing-1')
    const head2 = document.getElementById('landing-2')
  ...
  return (
    <div id="goto-home" className="-z-50 relative overflow-hidden w-[90%] h-screen flex flex-col items-center justify-center p-0">
      <h2 id="landing-1" className='fixed top-[20%] lg:top-[8%] font-bold text-black text-6xl md:text-8xl lg:text-[150pt]'>Hi there! I'm</h2>
      <h1 id="landing-2" className="fixed univers top-[28%] font-bold text-black md:text-[100pt] text-8xl lg:text-[150pt]">Aamir</h1>
