  ...
  return (
      <div id="goto-contact" className="flex flex-col justify-around items-center lg:flex-row lg:items-center lg:justify-around h-screen max-w-screen pt-20">
        <div className="w-10/12 flex justify-center">
          <a href="https://docs.google.com/document/d/1rywuRspQ3iU5hLmfXay_Z35_IJKpplL2otKaQy_bciw/edit?usp=sharing" className="bg-black text-primary text-3xl font-semibold w-fit h-full py-4 px-6 rounded-lg hover:bg-black/80 hover:scale-110">GET MY RESUME</a>
        </div>
        <div className="bg-black p-6 rounded-xl flex flex-col items-center justify-center text-white h-fit py-8 w-10/12 lg:w-1/2">
          ...
          <form action="" method="post" className="flex flex-col w-full">
            <input type="text" name="" id="" placeholder="Name" className="my-2 p-2 w-full" />
            <input type="email" name="" id="" placeholder="Email" className="my-2 p-2 w-full" />
            <textarea name="" id="" placeholder="Message" className="my-2 p-2 w-full"></textarea>
